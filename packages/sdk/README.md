...
const prover = new TeeRexProver("https://devnet.tee-rex.dev/prover", new WASMSimulator());
...
- **`apiUrl`** — TEE-Rex server endpoint (e.g. `https://devnet.tee-rex.dev/prover`)
...
```sh
npm add @alejoamiras/tee-rex@4.0.0-devnet.2-patch.3.12
```

Requirements:
- Aztec `4.0.0-devnet` or compatible version
