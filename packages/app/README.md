...
Demo frontend for TEE-Rex — compare local, remote, and TEE proving modes for Aztec transactions.
...
- Switching between local (WASM), remote, and TEE proving modes at runtime
