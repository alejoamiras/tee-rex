...
- **App** (`/packages/app`): Vite + vanilla TS frontend — 4-mode toggle (local/remote/nitro/sgx), timing, token flow
...
- **`docs/architecture.md`** — system overview, dual-TEE architecture (Nitro + SGX), package structure, infra layout.
- **`docs/sgx-deployment.md`** — step-by-step SGX provisioning, manifest reference, troubleshooting.
- **`docs/how-it-works.md`** — attestation protocols (Nitro + SGX), proving flow, security properties.
